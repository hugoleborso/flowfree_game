...
public class Controleur implements IControleur {
    ...
    private void notePlotChoisi(Couleur couleur, int ligne, int colonne) {
    	tuyauCourant.getCouleur().getDataCouleur().setCoordonnéesPlotChoisi(new int[] {ligne,colonne});
	}
    ...
    public int[] getPositionPremierPlot( Couleur couleur ) {
        return new int[] {couleur.getDataCouleur().getPostionsPlots().get(0).getI(),couleur.getDataCouleur().getPostionsPlots().get(0).getJ()};
    }

    
    @Override
    public int[] getPositionSecondPlot( Couleur couleur ) {
        return new int[] {couleur.getDataCouleur().getPostionsPlots().get(1).getI(),couleur.getDataCouleur().getPostionsPlots().get(1).getJ()};
    }
	...
	public int[] getPositionPlotChoisi(Couleur couleur) {
		return couleur.getDataCouleur().getCoordonnéesPlotChoisi();
	}
