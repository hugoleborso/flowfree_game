...
public class Panneau extends JPanel implements MouseListener {
    ...
    public void paint( Graphics g ) {
        ...
        for( Couleur couleur : Couleur.class.getEnumConstants() ) {
            ...
            if (dataCouleur.getPostionsPlots().size() != 0) {
	        	setCouleurGraphique( g, couleur );
	        	
	        	//On récupère les coordonnées des plots
	        	int[] posPremierPlot = new int[] {dataCouleur.getPostionsPlots().get(0).getI(),dataCouleur.getPostionsPlots().get(0).getJ()};
	        	int[] posDeuxiemePlot = new int[] {dataCouleur.getPostionsPlots().get(1).getI(),dataCouleur.getPostionsPlots().get(1).getJ()};
	        	int[] posDepartTuyau = dataCouleur.getCoordonnéesPlotChoisi();
