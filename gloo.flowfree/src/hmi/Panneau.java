    ...
    public void paint( Graphics g ) {
        ...
        for( Couleur couleur : Couleur.class.getEnumConstants() ) {
            if (couleur.getPostionsPlots().size() != 0) {
	        	...
	        	paintCasesDirections( g , posDepartTuyau, couleur.getDirectionsTuyau() , hauteurZoneTexte , couleur );
	            ...
	            paintDirections( g , posDepartTuyau, couleur.getDirectionsTuyau() , hauteurZoneTexte);
