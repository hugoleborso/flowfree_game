...
public class Panneau extends JPanel implements MouseListener {
        ...
        for( Couleur couleur : Couleur.class.getEnumConstants() ) {
            ...
            if (premierClicPlot) {
	            ...
	            if( Arrays.equals( posDepart, selection )) {
	            	decorationPlot(g,posDepart,coteCase,demiRayon,EPAISSEUR,diametrePlot);
	            }
	            if( Arrays.equals( posArrivee, selection )) {
	            	decorationPlot(g,posArrivee,coteCase,demiRayon,EPAISSEUR,diametrePlot);
	            }
            }
            ...
            paintDirections( g, posDepartTuyau, controleur.getDirections( couleur ));
            
        }
    }
    
    private void decorationPlot(Graphics g, int[] posDepart, int coteCase, int demiRayon, float epaisseur2, int diametrePlot ) {
    	Color c = g.getColor();
    ...
    private void paintDirections( Graphics g, int[] posDepart, ArrayList<Direction> directions ) {
        // Ici :
